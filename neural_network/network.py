...
class Network:
    ...
    def cost_function_partial_derivatives(self, output_layer_activation, sample_output):
        ...
        temp = output_layer_activation - sample_output
    ...
    def backprop(self, input_layer_activation, sample_output):
        ...
        for weight, bias in zip(self.weights, self.biases):
            aa = numpy.dot(weight, activation)
    ...
    def evaluate(self, test_data):
        ...
        for i,(x,y) in enumerate(test_data):
            ...
            if sample == deduction:
                correct += 1
        print('{0} correct in {1}'.format(str(correct), str(test_set_len)))
...
if __name__ == '__main__':
    ...
    net.mini_batch_stochastic_gradient_descent(training_set, 300, 10, 3.0, test_set)